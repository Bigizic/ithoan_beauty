...
<head>
  ...
  <title>Order Products Updated</title>
</head>
<body style="margin:0;padding:0;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;background:#f8f9fa;">
  ...
  <table cellpadding="0" cellspacing="0" border="0" width="100%" style="padding:40px 20px;">
    <tr>
      <td align="center">
        <h1 style="margin:0 0 10px 0;color:#131417;font-size:32px;font-weight:700;">Order Products Updated</h1>
        <p style="margin:0;color:#131417;font-size:18px;">Hi ${order.user.firstName}, your order has been updated</p>
      </td>
    </tr>
  </table>
        ...
        <table cellpadding="0" cellspacing="0" border="0" width="100%" style="max-width:100%;border-radius:8px;box-shadow:0 2px 8px rgba(0,0,0,0.1);">
          <tr>
            <td style="padding:40px 0px;">
              ...
              <!-- Update Message -->
              <table cellpadding="0" cellspacing="0" border="0" width="100%" style="border-left:4px solid #fb0000;padding:15px;margin:0 0 30px 0;border-radius:4px;">
                <tr>
                  <td>
                    <p style="margin:0;font-size:16px;color:#856404;font-weight:600;">${orderMsg}</p>
                  </td>
                </tr>
              </table>
              ...
              <!-- Updated Order Items -->
              <h2 style="margin:30px 0 20px 0;font-size:20px;font-weight:700;color:#131417;">Updated Order Items</h2>
