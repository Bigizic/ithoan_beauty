...
<body style="width:100%;margin:0;padding:0;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;background:#f8f9fa;">
  ...
  <table cellpadding="0" cellspacing="0" border="0" width="100%" style="padding:40px 20px;">
    <tr>
      <td align="center">
        <h1 style="margin:0 0 10px 0;color:#131417;font-size:32px;font-weight:700;">Order Confirmed!</h1>
        <p style="margin:0;color:#131417;font-size:18px;">Thank you for your purchase, ${order.user.firstName}</p>
      </td>
    </tr>
  </table>
        ...
        <table cellpadding="0" cellspacing="0" border="0" width="100%" style="max-width:100%;border-radius:8px;box-shadow:0 2px 8px rgba(0,0,0,0.1);">
          <tr>
            <td style="padding:40px 0px;">
              ...
              <!-- Order Info -->
              <p style="margin:0 0 20px 0;font-size:16px;color:#131417;">
              ...
              <!-- Order Items -->
              <h2 style="margin:30px 0 20px 0;font-size:20px;font-weight:700;color:#131417;">Your Order</h2>
