      ...
      <div className="flex flex-col max-w-screen-xl items-center gap-[48px] sm:gap-20 relative w-full">
        ...
        <div className="flex flex-col lg:flex-row gap-8 self-stretch w-full">
          <div className="flex flex-col lg:flex-row gap-8 flex-1">
            <div className="w-ful">
              <div className="flex gap-8 flex-col lg:grid grid-cols-2 lg:grid-cols-3 w-full">
                {firstServices.map((service, idx) => (
                  <Card
                    key={idx}
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <span
                          className="relative w-fit font-text-regular-normal font-[number:var(--text-regular-normal-font-weight)] text-[length:var(--text-regular-normal-font-size)] tracking-[var(--text-regular-normal-letter-spacing)] leading-[var(--text-regular-normal-line-height)] whitespace-nowrap [font-style:var(--text-regular-normal-font-style)]"
                        >
                          Book Appointment
                        </span>
            ...
            {/*lastService.map((service, idx) => (

              <Card key={idx} className="flex flex-col flex-1 self-stretch bg-[#e6e1c9] rounded-[10px] overflow-hidden border border-solid border-[#1c1c1c]">
                ...
                <CardContent className="flex flex-col items-start justify-center gap-6 md:gap-8 p-6 sm:p-12 pl-6 flex-1">
                  <div className="flex flex-col items-start gap-2 relative self-stretch w-full">
                    ...
                    <div className="flex flex-col items-start gap-2 sm:gap-6 relative self-stretch w-full">
                      ...
                      <p dangerouslySetInnerHTML={{ __html: service.description }} data-aos="fade-right" data-aos-delay={100 * 2 + 100} className="relative self-stretch font-text-regular-normal font-[number:var(--text-regular-normal-font-weight)] text-[#1c1c1c] text-[length:var(--text-regular-normal-font-size)] tracking-[var(--text-regular-normal-letter-spacing)] leading-[var(--text-regular-normal-line-height)] [font-style:var(--text-regular-normal-font-style)]">
                      </p>
                    </div>
                  </div>
