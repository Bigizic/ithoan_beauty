...
export const VitaminCFrame = () => {
  const ingredients = [
    ...
    {
      name: "Xanthan Gum",
      description: "Provides a silky texture and helps stabilizes the serum properly",
    },
    {
      name: "Glycerin",
      description: "A natural humectant that draws moisture into the skin for lasting hydration",
    },
    {
      name: "Water",
      description: "Acts as a hydrating base, helping other ingredients absorb smoothly",
    },
  ];
        ...
        <div className="flex flex-col items-center justify-center gap-4 lg:w-1/2">
          ...
          <div className="flex flex-col gap-2 text-center lg:text-left w-full mt-4">
            ...
            <p className="font-poppins text-sm sm:text-base text-gray-800 leading-relaxed">
              To be used after a facial cleansing, apply to the face and gently massage till it absorbs.
            </p>
          </div>
        </div>
