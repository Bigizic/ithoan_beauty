...
export const fetchOurCollections = () => {
  return async (dispatch, getState) => {
    try {
      const response = await axios.get(`${API_URL}/category/our_collections`);

      dispatch({
        type: SET_HOME_PAGE_COLLECTIONS,
