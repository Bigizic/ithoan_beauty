        ...
        <div className="flex-col gap-8 self-stretch w-full flex-[0_0_auto] flex items-start relative">
          <Card className="gap-32 px-6 py-12 self-stretch w-full flex-[0_0_auto] bg-[#1c1c1c] rounded-[5px] border-[#eabe30] flex items-start relative border border-solid">
            <CardContent className="flex-col sm:flex-row flex items-start gap-10 relative flex-1 grow p-0">
              <div className="flex w-full sm:w-fit justify-center flex-col items-center">
                <img
                  className="relative w-[112px] h-22 sm:w-[322px] sm:h-[286px] object-cover"
                  alt="Removal"
                  src="/logo_no_bg_p.png"
                />
                <p className="text-other font-alex-brush text-[22px] sm:text-[32px] -tracking-tight">Tohanniees Beauty</p>
              </div>
              <div className="flex-row flex items-start gap-10 relative flex-1 grow p-0 flex-wrap justify-center w-full">
          ...
          <div className="flex flex-col items-start gap-8 relative self-stretch w-full flex-[0_0_auto]">
            <div className="flex justify-between self-stretch w-full items-start relative flex-[0_0_auto] md:flex-nowrap flex-wrap gap-[1em] md:gap-0">
              <div className="inline-flex items-center gap-6 relative flex-[0_0_auto] w-full flex-wrap">
                <div className="relative w-fit mt-[-1.00px] text-xs sm:font-text-small-normal font-[number:var(--text-small-normal-font-weight)] text-white text-[length:var(--text-small-normal-font-size)] tracking-[var(--text-small-normal-letter-spacing)] leading-[var(--text-small-normal-line-height)] whitespace-nowrap [font-style:var(--text-small-normal-font-style)]">
