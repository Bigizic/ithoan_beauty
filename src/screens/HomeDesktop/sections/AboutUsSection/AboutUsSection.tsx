  ...
  return (
    <section className="min-h-[849px] why-choose-us-bg flex flex-col w-full items-center gap-20 pd-default py-28 relative">
      <div className="max-w-screen-md items-center gap-6 w-full flex-[0_0_auto] flex flex-col relative">
        <h2 className="relative self-stretch mt-[-1.00px] [font-family:'Bricolage_Grotesque',Helvetica] font-bold text-white text-5xl text-center tracking-[0] leading-[57.6px]">
          Why Choose Us
        </h2>
          ...
          <div className="items-start gap-8 flex-1 grow flex flex-col relative">
            <div className="flex flex-col items-start gap-4 relative self-stretch w-full flex-[0_0_auto]">
              <div className="inline-flex items-center relative flex-[0_0_auto]">
                <span className="relative w-fit mt-[-1.00px] font-heading-tagline font-[number:var(--heading-tagline-font-weight)] text-white text-[length:var(--heading-tagline-font-size)] tracking-[var(--heading-tagline-letter-spacing)] leading-[var(--heading-tagline-line-height)] whitespace-nowrap [font-style:var(--heading-tagline-font-style)]">
                  Relax. Refresh. Renew
                </span>
              </div>

              <div className="flex flex-col items-start gap-6 relative self-stretch w-full flex-[0_0_auto]">
                <h3 className="relative self-stretch mt-[-1.00px] font-heading-h2 font-[number:var(--heading-h2-font-weight)] text-white text-[length:var(--heading-h2-font-size)] tracking-[var(--heading-h2-letter-spacing)] leading-[var(--heading-h2-line-height)] [font-style:var(--heading-h2-font-style)]">
              ...
              {features.map((feature, index) => (
                ...
                >
                  <CardContent className="flex flex-col items-start gap-6 p-0">
                    ...
                    <h4 className="relative self-stretch font-heading-h4 font-[number:var(--heading-h4-font-weight)] text-white text-[length:var(--heading-h4-font-size)] tracking-[var(--heading-h4-letter-spacing)] leading-[var(--heading-h4-line-height)] [font-style:var(--heading-h4-font-style)]">
                      {feature.title}
                    </h4>
