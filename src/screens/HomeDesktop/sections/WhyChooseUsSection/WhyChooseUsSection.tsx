...
export const WhyChooseUsSection = ({ services, loading }: WhyChooseUsProps) => {
  if (loading) {
    return (
      ...
      <div className="flex flex-col max-w-screen-xl items-center gap-20 relative w-full">
        <header className="flex flex-col max-w-screen-md items-center gap-4 relative w-full">
          ...
          <div className="flex flex-col items-center gap-6 relative self-stretch w-full">
            ...
            <h2 className="relative self-stretch [font-family:'Bricolage_Grotesque',Helvetica] font-bold text-[#1c1c1c] text-5xl text-center tracking-[0] leading-[57.6px]">
                ...
                >
                  ...
                  <CardContent className="flex flex-col items-start justify-center gap-6 p-6">
                    <div className="flex flex-col items-start gap-2 relative self-stretch w-full">
                      <div className="inline-flex items-center relative">
                        <div className="relative w-fit mt-[-1.00px] font-heading-tagline font-[number:var(--heading-tagline-font-weight)] text-[#1c1c1c] text-[length:var(--heading-tagline-font-size)] tracking-[var(--heading-tagline-letter-spacing)] leading-[var(--heading-tagline-line-height)] whitespace-nowrap [font-style:var(--heading-tagline-font-style)]">
                          {service.category}
                        </div>
                      </div>

                      <div className="flex flex-col items-start gap-2 relative self-stretch w-full">
                        <h3 className="relative self-stretch mt-[-1.00px] [font-family:'Bricolage_Grotesque',Helvetica] font-bold text-[#1c1c1c] text-2xl tracking-[0] leading-[33.6px]">
                          {service.title}
                        </h3>

                        <p className="relative self-stretch font-text-regular-normal font-[number:var(--text-regular-normal-font-weight)] text-[#1c1c1c] text-[length:var(--text-regular-normal-font-size)] tracking-[var(--text-regular-normal-letter-spacing)] leading-[var(--text-regular-normal-line-height)] [font-style:var(--text-regular-normal-font-style)]">
                          {service.description}
                        </p>
                      </div>
                    </div>
              ...
              <CardContent className="flex flex-col items-start justify-center gap-6 md:gap-8 p-12 pl-6 flex-1">
                <div className="flex flex-col items-start gap-2 relative self-stretch w-full">
                  ...
                  <div className="flex flex-col items-start gap-6 relative self-stretch w-full">
                    <h3 className="mt-[-1.00px] [font-family:'Bricolage_Grotesque',Helvetica] text-[#1c1c1c] text-[32px] md:text-[40px] leading-[48.0px] relative self-stretch font-bold tracking-[0]">
                      {services[4].title}
                    </h3>
                ...
                <Link href={`/booking?service=${services[4].slug}`}>
                  <Button
                    variant="outline"
                    className="h-auto inline-flex items-center justify-center gap-2 p-2 rounded-[5px] border border-solid border-[#1c1c1c] bg-transparent hover:bg-[#1c1c1c] hover:text-white"
                  >
